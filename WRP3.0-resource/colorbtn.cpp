...
BOOL CColorBtn::OnChildNotify(UINT message, WPARAM wParam, LPARAM lParam, LRESULT* pLResult) 
{
	// TODO: Add your specialized code here and/or call the base class
	BOOL bl=CButton::OnChildNotify(message, wParam, lParam, pLResult);
...
{//RGB(58,110,165)
	static COLORREF custcr[16]={0xffffff,0xffffff,0xffffff,0xffffff,
		0xffffff,0xffffff,0xffffff,0xffffff,0xffffff,0xffffff,
		0xffffff,0xffffff,0xffffff,0xffffff,0xffffff,0xffffff
	};
	static CHOOSECOLOR cc={
		sizeof(CHOOSECOLOR),NULL,NULL,0xffffff,custcr,
			CC_FULLOPEN|CC_ANYCOLOR|CC_RGBINIT,NULL,NULL,NULL
	};
	cc.hwndOwner=m_hWnd;
...
void CColorBtn::SetCurrentColor(COLORREF color)
{
	currentcolor=color;
	Invalidate();
}
