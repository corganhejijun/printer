 ...
 */
bool DL_Dxf::in(const wchar_t* file, DL_CreationInterface* creationInterface) {
    FILE *fp;
    firstCall = true;
    currentEntity = DL_UNKNOWN;
    int errorCounter = 0;

    errno_t err = _wfopen_s(&fp, file, L"rt");
    if (err == 0) {
...
bool DL_Dxf::processDXFGroup(DL_CreationInterface* creationInterface,
    ...
    // Indicates start of new entity or var
        ...
        if ((values[8])[0]!='\0') {
            strcpy_s(name, strlen(values[8])+1, values[8]);
        }
        // defaults to layer '0':
        else {
            strcpy_s(name, 2, "0");
        ...
        strcpy_s(linetype, DL_DXF_MAXLINE+1, toString(values[6], "BYLAYER"));
        ...
        if (groupValue[0]=='$') {
            ...
            strncpy_s(settingKey, DL_DXF_MAXLINE, groupValue, DL_DXF_MAXLINE);
        ...
        if (groupCode<DL_DXF_MAXGROUPCODE) {
            ...
            if (!handled) {
                ...
                strncpy_s(values[groupCode], DL_DXF_MAXLINE, groupValue, DL_DXF_MAXLINE);
...
void DL_Dxf::addLayer(DL_CreationInterface* creationInterface) {
    ...
    if (!_stricmp(attrib.getLineType().c_str(), "BYLAYER") ||
            !_stricmp(attrib.getLineType().c_str(), "BYBLOCK")) {
...
void DL_Dxf::writeLineType(DL_WriterA& dw,
    ...
    if (version<DL_VERSION_2000) {
		if (!_stricmp(data.name.c_str(), "BYBLOCK") ||
		    !_stricmp(data.name.c_str(), "BYLAYER")) {
			return;
		}
	}
    ...
    } else if (!_stricmp(data.name.c_str(), "BYLAYER")) {
        dw.tableLineTypeEntry(0x15);
    } else if (!_stricmp(data.name.c_str(), "CONTINUOUS")) {
    ...
    if (!_stricmp(data.name.c_str(), "BYBLOCK")) {
        ...
        dw.dxfInt(73, 0);
        dw.dxfReal(40, 0.0);
    } else if (!_stricmp(data.name.c_str(), "ACAD_ISO02W100")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "ACAD_ISO03W100")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "ACAD_ISO04W100")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "ACAD_ISO05W100")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "BORDER")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "BORDER2")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "BORDERX2")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "CENTER")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "CENTER2")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "CENTERX2")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "DASHDOT")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "DASHDOT2")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "DASHDOTX2")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "DASHED")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "DASHED2")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "DASHEDX2")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "DIVIDE")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "DIVIDE2")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "DIVIDEX2")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "DOT")) {
        dw.dxfString(3, "Dot . . . . . . . . . . . . . . . . . . . . . .");
        dw.dxfInt(72, 65);
        dw.dxfInt(73, 2);
        dw.dxfReal(40, 6.35);
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "DOT2")) {
        ...
        if (version>=DL_VERSION_R13)
            dw.dxfInt(74, 0);
    } else if (!_stricmp(data.name.c_str(), "DOTX2")) {
...
void DL_Dxf::writeBlock(DL_WriterA& dw, const DL_BlockData& data) {
    ...
    if (!_stricmp(data.name.c_str(), "*paper_space")) {
        dw.sectionBlockEntry(0x1C);
    } else if (!_stricmp(data.name.c_str(), "*model_space")) {
        dw.sectionBlockEntry(0x20);
    } else if (!_stricmp(data.name.c_str(), "*paper_space0")) {
...
void DL_Dxf::writeEndBlock(DL_WriterA& dw, const string& name) {
    if (!_stricmp(name.c_str(), "*paper_space")) {
        dw.sectionBlockEntryEnd(0x1D);
    } else if (!_stricmp(name.c_str(), "*model_space")) {
        dw.sectionBlockEntryEnd(0x21);
    } else if (!_stricmp(name.c_str(), "*paper_space0")) {
...
int DL_Dxf::getLibVersion(const char* str) {
    ...
    if (idx==3) {
        ...
        strncpy_s(v[0], d[0], str, d[0]);
        v[0][d[0]] = '\0';

        strncpy_s(v[1], d[1]-d[0]-1, &str[d[0]+1], d[1]-d[0]-1);
        v[1][d[1]-d[0]-1] = '\0';

        strncpy_s(v[2], d[2]-d[1]-1, &str[d[1]+1], d[2]-d[1]-1);
        v[2][d[2]-d[1]-1] = '\0';

        strncpy_s(v[3], d[3]-d[2]-1, &str[d[2]+1], d[3]-d[2]-1);
        v[3][d[3]-d[2]-1] = '\0';
